...
import { CurrentCarResponseModel } from '../models/currentCarResponseModel';
...
export class CarService {
  ...
  getCarsById(carId:number): Observable<CurrentCarResponseModel> {
    let newPath = this.apiUrl + "cars/getbycarid?id="+carId;
    return this.httpClient.get<CurrentCarResponseModel>(newPath)
  }
  ...
  getCarsDetailByCarId(carId: number): Observable<ListResponseModel<CarDetail>> {
